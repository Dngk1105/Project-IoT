...
class DeviceManagerService:
    ...
    async def process_lifecycle_status(self, device_id: str, action: str, payload: dict):
    ...
    async def process_hardware_telemetry(self, device_id: str, action: str, payload: dict):
        timestamp = payload.get("timestamp") 
    ...
    async def process_device_shadow(self, device_id: str, action: str, payload: dict):
